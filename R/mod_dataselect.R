...
mod_dataselect_ui <- function(id){
  ...
  tagList(
    ...
    selectInput(inputId = ns("select_spp"),
                ...
                choices =  data1$species,#c("Chinook (CH)", "Steelhead (STL)"),
                selected = "Chinook",
                width = "200px",
                multiple = T),
    ...
    selectInput(inputId = ns("select_rear"),
                ...
                choices = data1$rear_type, #c("Wild (W)", "Hatchery (H)"),
    ...
    selectInput(inputId = ns("select_cov"),
                ...
                choices = data1$covariate, #c("Day of Year (DOY)", "Temperature"),
    ...
    shinyWidgets::pickerInput(inputId = ns("select_year"),
                              label = "Select years",
                              choices = unique(data1$year),#1993:2018,
