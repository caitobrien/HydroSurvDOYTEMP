  ...
  tagList(
    fluidRow(
      ...
      shinydashboard::box(
        ...
        br(),
        includeHTML("inst/app/www/table.html"),
        br(),
      ...
      #   tabsetPanel(
      #     id = "myTabs",
      #     tabPanel("Natural-origin Chinook", includeHTML("inst/app/www/table_mod_hatchery_chinook_doy.html")),
      #     tabPanel("Hatchery-origin Chinook", includeHTML("inst/app/www/table_mod_hatchery_chinook_doy.html")),
      #     tabPanel("Natural-origin Steelhead", includeHTML("inst/app/www/table_mod_hatchery_chinook_doy.html")),
      #     tabPanel("Hatchery-origin Steelhead", includeHTML("inst/app/www/table_mod_hatchery_chinook_doy.html"))
      #   ),
      #   fluidRow(
      #     column(
      #       width = 12,
