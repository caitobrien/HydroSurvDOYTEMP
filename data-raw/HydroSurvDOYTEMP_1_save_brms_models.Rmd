...
mod_natural_chinook_doy_prior <- brm(alive | trials(n) ~ doyz + I(doyz^2) + transport + doyz:transport + I(doyz^2):transport + (1 + doyz + I(doyz^2) + transport | year), 
                   ...
                   cores = 3,
                   prior = bprior,
                   file = here("data-raw/models", "mod_natural_chinook_doy_prior5")
                   )
...
shinystan::launch_shinystan(mod_natural_chinook_doy_prior)
...
#save models
saveRDS(mod_doy, file = here::here("data-raw/HydoSurvDOYTEMP/models/prior", paste0("mod_", gsub("_data_subset.csv", "_doy.rds", filename))))
saveRDS(mod_temp, file = here::here("data-raw/HydoSurvDOYTEMP/models/prior", paste0("mod_", gsub("_data_subset.csv", "_temp.rds", filename))))
}
