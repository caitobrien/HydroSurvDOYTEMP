...
model_files_doy <- list.files(path = here::here("data-raw/models/prior"), pattern = paste0("mod_", rear_type, "_", species, "_doy.rds"), full.names = TRUE)

# Get list of associated model files for temp
model_files_temp <- list.files(path = here::here("data-raw/models/prior"), pattern = paste0("mod_", rear_type, "_", species, "_temp.rds"), full.names = TRUE)
