...
This code is was used to produce the subsetted dataset used for each model which can be found in the data-raw/ folder. 
...
This code is used to import BON river temperature data and calculate 7-day rolling averages for the years 1993-2018. The data is then merged with a larger dataset for further analysis. 
